          ...
          <form role="form" action="<?php base_url('users/create') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" data-type="currency" id="price" name="price" placeholder="Enter price" autocomplete="off" />
                </div>
                <div class="form-group">
                    <label for="discount">Discount</label>
                    <input type="text" class="form-control" data-type="currency" id="discount" name="discount" placeholder="Discount" autocomplete="off">
                </div>
                <div class="form-group">
                  <label for="qty">Qty</label>
                  <input type="number" min="0" class="form-control" id="qty" name="qty" placeholder="Enter Qty" autocomplete="off" />
                </div>
